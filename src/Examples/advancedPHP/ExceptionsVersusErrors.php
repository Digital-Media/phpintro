...
class ExceptionsVersusErrors
{
    ...
    {
        // TODO uncomment commented lines and see which echos disappear,
        // TODO to find out differences between exceptions errors and parse problems
        ...
        //§this->hugo; // Gives HTTP Status 500: Page not working.
        // Error only seen in /var/log/apache2/error.log -> File can't be parsed correctly
    }
}
...
try {
    ...
    echo "This is my first Exception thrown in " . $e->getFile() . " on line "
